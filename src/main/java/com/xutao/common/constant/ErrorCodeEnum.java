    package com.xutao.common.constant;
    ...
    public enum ErrorCodeEnum {
         ...
         * 用户手机已经注册过了
         */
        USER_PHONE_EXIST("A0112", "用户手机已经注册过"),
         ...
         * QQ验证码失效
         */
        USER_QQ_CODE_INVALID("A0702", "QQ验证码失效或未发送"),

        /**
         * QQ验证码错误
         */
        USER_QQ_CODE_ERROR("A0703", "QQ验证码错误"),
         ...
         * 一级宏观错误码，qq邮件发送失败
         */
        Phone_VERIFICATION_CODE_SEND_ERROR("C0310","手机验证码发送错误"),

        /**
         * 一级宏观错误码，qq邮件发送失败
         */
        QQ_VERIFICATION_CODE_SEND_ERROR("C0210","QQ验证码发送错误");
