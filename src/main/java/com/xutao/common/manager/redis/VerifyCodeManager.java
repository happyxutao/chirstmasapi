package com.xutao.common.manager.redis;


import com.xutao.common.constant.CacheConsts;
import com.xutao.common.utils.ImgVerifyCodeUtils;
...
public class VerifyCodeManager {
     ...
     * 从 Redis 中取得qq验证码
     */
    public String getQqVerifyCode(String email){
       return stringRedisTemplate.opsForValue().get(CacheConsts.QQ_MAIL_VERIFY_CACHE_KEY+email);
    }
}
